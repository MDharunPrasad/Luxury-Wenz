    ...
    <section className="py-20 bg-gradient-to-b from-ivory to-platinum/30">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mt-16">
          <a 
            href="/listings"
            className="inline-flex items-center space-x-3 px-8 py-4 rounded-full bg-[#D4AF37]/80 text-white font-semibold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 group"
          >
